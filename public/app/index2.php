...
require_once('req/php-excel-reader/excel_reader2.php');
require_once('req/SpreadsheetReader.php');
        ...
        for($i=0;$i<$sheetCount;$i++)
        {
            ...
            foreach ($Reader as $Row)
            {
                ...
                if (!empty($id) || !empty($ANNEE_MARCHE)) {
                    $query = "insert into cour_class1s(id,ANNEE_PRET,ANNEE_MARCHE,NOM_BENEFICIAIRE,NUMERO_DU_PRET,NUMERO_MARCHE,OBJET_DU_MARCHE,TYPE_FOURNISSEUR,MONTANT_ENGAGE,MONTANT_ORDONNANCE,MONTANT_PAYE,MONTANT_SIGNALE)
                     values('".$id."','".$ANNEE_PRET."','".$ANNEE_MARCHE."','".$NOM_BENEFICIAIRE."','".$NUMERO_DU_PRET."','".$NUMERO_MARCHE."','".$OBJET_DU_MARCHE."','".$TYPE_FOURNISSEUR."','".$MONTANT_ENGAGE."','".$MONTANT_ORDONNANCE."','".$MONTANT_PAYE."','".$MONTANT_SIGNALE."')";
